...
class Deck(name: String) {
    ...
    fun addCard() {
        ...
        print("\tTeclea el tipo (0 -> Card // 1 -> Cloze // 2 -> Definition): ")
        ...
        if (tipo == 0) {
            ...
            if (!question.contains("*")) {
                println("La tarjeta creada no es de tipo Cloze")
                return
            }
    ...
    fun showStatistics() {
        ...
        if (maxEasiness == easinessCard) println("Card")
        else if (maxEasiness == easinessCloze) println("Cloze")
        else if (maxEasiness == easinessDefinition) println("Definition")
        var minEasiness = minOf(easinessCard, easinessCloze, easinessDefinition)
        print("Categoría menos aprendida: ")
        if (minEasiness == easinessCard) println("Card")
        else if (minEasiness == easinessCloze) println("Cloze")
        else if (minEasiness == easinessDefinition) println("Definition")
    }
